...
[![codecov](https://codecov.io/gh/luk036/digraphx-cpp/branch/master/graph/badge.svg)](https://codecov.io/gh/luk036/digraphx-cpp)
...
- Replace all occurrences of "DiGraphX" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `DiGraphX` means the name of the project, while `digraphx` is used in file names.
